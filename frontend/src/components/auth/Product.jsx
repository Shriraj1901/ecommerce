...
const Product = ({ _id, name, images, description, price }) => {
  ...
  const currentImage = images?.[currentIndex] || ""; // Ensure images exist before accessing
    ...
    <div className="bg-white p-4 rounded-lg shadow-lg hover:shadow-2xl transform transition-transform hover:scale-105 flex flex-col items-center">
      ...
      <div className="w-full text-center">
        ...
        <button
          ...
          onClick={() => navigate(`/product/${_id}`)} // Fixed Template Literal
        >
          More Info
        </button>
      </div>
...
Product.propTypes = {
  ...
  images: PropTypes.arrayOf(PropTypes.string).isRequired, // Fixed images type
